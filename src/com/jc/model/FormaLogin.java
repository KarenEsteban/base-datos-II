...
int posY;
    ...
    posY=banner.getY();
     ...
     while(true){
         try{
             banner.setLocation(posxInicial, posY);
             Thread.sleep(10);
    ...
    private void initComponents() {
        ...
        Autenticar.setBackground(new java.awt.Color(255, 255, 255));
        ...
        banner.setText("promociones del mes!!!");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(textoPassword, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(25, 25, 25)
                        .addComponent(banner, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void AutenticarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AutenticarActionPerformed
        ...
        if(textoLogin.getText().equals("admin")&&textoPassword.getText().equals("123")){
            Cinepolis cine=new Cinepolis();
            cine.pack();
            cine.setVisible(true);
            dispose();
        }else{
            JOptionPane.showMessageDialog(this, "Datos incorrectos, intenta d nuevo");
        }
